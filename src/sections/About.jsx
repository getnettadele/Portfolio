...
const highlights = [
    ...
    },
    {
        ...
        title: "Performance",
        description:
        "Optimizing for speed and delivering lightning-fast user experiance.",
    },
    {
        icon: Users,
        title: "Collaboration",
    ...
    },
    {
        ...
        title: "Inovation",
        description:
        "Working ahead with the latest technologies and best practices.",
    },
];
export const About = () => {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                            <p>
                                I'm a passionated software engineer with over 1 year of experiance
                        ...
                        <div className="glass rounded-2xl p-6 glow-border animate-fade-in animation-delay-300">
                           <p className="text-lg font medium italic text text-foreground">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        {highlights.map((item, idx) => (
                            ...
                            style={{animationDelay: `{(idx +1) *100}ms`}}>
                                <div className="w-12 h-12 rounded-xl bg-primary/10 flex item-center justify-center mb-4 hover:bg-primary/20">
